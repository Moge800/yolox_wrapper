...
詳細なドキュメントは [docs/](docs/index.md) を参照してください。

- [インストール](docs/installation.md)
- [クイックスタート](docs/quickstart.md)
- [設定ファイル](docs/configuration.md)
- [GUI ガイド](docs/gui.md)
- API リファレンス: [YOLOX](docs/api/wrapper.md) / [AppConfig](docs/api/config.md) / [DatasetPreparer](docs/api/dataset.md) / [Trainer](docs/api/trainer.md)
